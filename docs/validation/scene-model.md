...
- Debug GPU 验证使用 `MTL_DEBUG_LAYER=1 MTL_SHADER_VALIDATION=1 SPECTRAL_VALIDATE=1 SPECTRAL_SPP=32 SPECTRAL_OUTPUT=/tmp/SpectralPT-scene-final /tmp/SpectralPT-scene/Build/Products/Debug/SpectralPT.app/Contents/MacOS/SpectralPT`。
